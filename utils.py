...
def fail_if_middle_not_included(
    word: str, row_idx: int, col_idx: int, axis: int
) -> None:
...
def letter_in_original_row_or_column(
    board_i: int, original_idx: int, axis: int
) -> bool:
