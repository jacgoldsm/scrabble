...
_2w_idx = [
    ...
    if (i % 16 == 0 or i % 14 == 0)
    and (
        utils.idx_to_row_column_idx(i)[0]
        not in range(5, 10)  # row not in [5,9) except for center square
        or i == 112
    )
]
...
_3l_idx_rowcols_2h = [(14 - i, j) for i, j in _3l_idx_rowcols_1h]
...
_2l_idx_rowcols_2h = [(14 - i, j) for i, j in _2l_idx_rowcols_1h]
